Document management system connector provides a set of specific functionalities meant for integrating D365FO with an external document management system (DMS). These functionalities enable:
