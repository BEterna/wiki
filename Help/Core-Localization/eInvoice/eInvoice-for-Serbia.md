...
#**Test cases**
________________________________________
1. Standard discounts can be used on Invoices and are calculated to fit eFaktura portal logic by using standard fields (Quantity, Unit price, Discount, Discount percent, Total discount). Check [**Test scenarios for Discounts**](/.attachments/Test-scenarios-Discounts-8fafc905-8abd-4f20-b4cd-1057cddbdfce.zip)
