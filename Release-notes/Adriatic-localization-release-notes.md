...
|General ledger features- ExLoc| Within Propose balancing general ledger functionality new field was added - Posting date. Now it is possible to define posting date on all lines in a general journal.| New feature
